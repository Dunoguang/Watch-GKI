...
static int z_erofs_lz4_decompress(struct z_erofs_decompress_req *rq, u8 *out)
{
	 ...
	 * always use LZ4_decompress_safe_partial(): the modern (5.4+)
	 * erofs legacy LZ4 blocks are not fully terminated and only
	 * LZ4_decompress_safe_partial() can decode them.
	 */
